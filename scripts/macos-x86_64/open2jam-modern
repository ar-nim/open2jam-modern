#!/bin/bash
#
# open2jam-modern - Launch script for macOS
#
...
if [ "$JAVA_MAJOR_VERSION" -lt 21 ]; then
    echo "Warning: Java version $JAVA_VERSION detected. Java 21+ is recommended."
fi
...
# This results in max 4.8GB heap (30% of 16GB)
JVM_OPTS=(
    "-XX:MaxRAM=16G"
